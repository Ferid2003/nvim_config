...
local function java_keymaps()
    ...
    -- Set a Vim motion to <Space> + <Shift>J + m to extract the code under the cursor into a method
    vim.keymap.set('n', '<leader>Jm', "<Cmd> lua require('jdtls').extract_method()<CR>", { desc = "[J]ava Extract Into [M]ethod" })
    -- Set a Vim motion to <Space> + <Shift>J + m to extract the code selected in visual mode into a method
    vim.keymap.set('v', '<leader>Jm', "<Esc><Cmd> lua require('jdtls').extract_method(true)<CR>", { desc = "[J]ava Extract Into [M]ethod" })
